...
public class TestDatedifferenceProvider {
	public static void main(String[] args) {
			 ...
			 DatedifferenceProvider dateDifference=new DatedifferenceProvider();
			 ...
			 {
				 long calculatedDiff=dateDifference.getDateDifference(myTestRecord[index].startdate,myTestRecord[index].enddate);
